	...
	public class xnumcor {
        ...
        #region Metodos
            ...
            { 
                ...
                {
                    this._cxncnumcor=ResultadoConsulta.GetDecimal(0);
            ...
            { 
                ...
                { 
                    ...
                    this.Conexion.AsignarParametroDecimal("@cxncnumcor",this._cxncnumcor);
                    this.Conexion.AsignarParametroCadena("@pxnctipcor",this._pxnctipcor);
            ...
            { 
                ...
                if (ResultadoConsulta!=null)
                {
                    while (ResultadoConsulta.Read())
                    {
                          ...
                          Auxiliar.cxncnumcor = ResultadoConsulta.GetDecimal(0);
